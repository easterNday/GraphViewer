...
@Entity  // 声明当前类为一个实体类
@Table(name = "entity")  // 指定当前实体类对应的数据库表名称为 entity
...
public class EntModel {
    ...
    @Column(name = "has_entity1_relation") // 指定当前字段在数据库表中的列名为 has_entity1_relation
    private Boolean hasEntity1Relation;  // 实体类中的一个字段，类型为 Boolean ，名称为 hasEntity1Relation
}